...
// QNX System Headers (Target: QNX Momentics IDE)
...
// Deterministic pulse timer for periodic tasks
...
void* generic_sensor_client(void* arg) {
    ...
    while (system_run) {
        ...
        // MsgSend blocks until reply is received (Synchronous IPC)
...
void* fusion_server_thread(void* arg) {
    ...
    while (system_run) {
        // Receive message or pulse (Priority Inheritance active)
